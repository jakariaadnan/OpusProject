...
namespace OPUSProject.Controllers
{
    public class YearsController : Controller
    {
        ...
        public YearsController(dbModel context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ManufactureYear")] Year year)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ManufactureYear")] Year year)
        {
            if (id != year.Id)
            {
                return NotFound();
